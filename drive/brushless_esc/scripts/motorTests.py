from rover_embedded.drive.esc_can.drive_can_communication import (
    NodeID, DriveInterface, CANStation
)
import time

def test1(drive: DriveInterface):
...
def test2(drive: DriveInterface):
...
def test3(drive: DriveInterface):
...
def test4(drive: DriveInterface):
...
def test5(drive: DriveInterface):
...
def test6(drive: DriveInterface):
...
def test7(drive: DriveInterface):
...
def test8(drive: DriveInterface, station:CANStation):
...
def test9(drive: DriveInterface, station:CANStation):
...
def test10(drive: DriveInterface, station:CANStation):
...
def test11(drive: DriveInterface, station:CANStation):
...
def test12(drive: DriveInterface, station:CANStation):
...
def test13(drive: DriveInterface, station:CANStation):
...
def test14(drive: DriveInterface, station:CANStation):
