...
/*
  * @brief  R3_C0XX parameters definition
  */
typedef struct
{
...
/*
  * @brief  Handle structure of the R1_C0xx_pwm_curr_fdbk Component
  */
typedef struct
{
...
/*
  * Configure the ADC for the current sampling related to sector X (X = [1..6] ) in case of overmodulation.
  */
