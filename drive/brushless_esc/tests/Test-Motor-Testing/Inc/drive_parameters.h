...
#define MAX_APPLICATION_SPEED_RPM           2590 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT               2164
#define PID_TORQUE_KI_DEFAULT               2072
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2164
#define PID_FLUX_KI_DEFAULT                 2072
...
#define PID_SPEED_KP_DEFAULT                3725/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            358
...
#define PHASE1_FINAL_CURRENT_A              6.5

/* Phase 2 */
#define PHASE2_DURATION                     796 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (398*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              6.5

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (398*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              6.5

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (398*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              6.5

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (398*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              6.5
