...
#define RS                      1.12 /* Stator resistance , ohm*/
...
#define MOTOR_MAX_SPEED_RPM     2590 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  16.1 /*!< Volts RMS ph-ph /kRPM */
#define NOMINAL_CURRENT_A       6.5

#define ID_DEMAG_A              -6.5 /*!< Demagnetization current */
