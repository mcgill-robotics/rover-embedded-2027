...
#define PID_TORQUE_KP_DEFAULT               2321
#define PID_TORQUE_KI_DEFAULT               2642
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2321
...
#define PID_SPEED_KP_DEFAULT                3541/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                2075/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
